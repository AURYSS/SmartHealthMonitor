package mx.utng.carh.smarthealthmonitor.data.repository
...
import mx.utng.carh.smarthealthmonitor.data.remote.NeonClient
import mx.utng.carh.smarthealthmonitor.data.remote.NeonRequest
...
class SyncRepository(
    ...
    suspend fun sincronizarDesdeNeon(limite: Int = 50) = withContext(Dispatchers.IO) {
        try {
            ...
            android.util.Log.e("SYNC", "Error descargando de Neon: ${e.message}")
        }
    }
